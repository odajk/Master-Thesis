...
\end{equation*}
\todo{Dette er for kontinuerlig tilfelle}
...
\end{definition}
If a continous Markov chain satisfy the conditions of irreducibility, recurrency and aperiodicity, then there exists a unique distribution $\left(p\left(\theta\right)$ \todo{Er det greit å bruke $\left(\theta\right)$ her? }  
\begin{equation*}
